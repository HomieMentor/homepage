        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <button
              ...
              className="relative w-14 h-8 bg-slate-200 rounded-full p-1 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
            >
              <div
